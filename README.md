...
`Prompt_1` & `Prompt_2`: LLM output and results of repeated Bertrand duopoly experiment respective prompt prefix
...
Since LLMs are run locally via Ollama, the following models must be installed a priori:
```
gemma3:4b
mistral:7b
starling-lm:7b
